                        ...
                        <div v-if="mode === 'create' || showPasswordField">
                            ...
                            <div class="relative">
                                <input 
                                    ...
                                    class="w-full px-3 py-2 pr-10 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-white" 
