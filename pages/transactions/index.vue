<template>
    <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input
                        v-model="searchTerm"
                        type="text"
                        placeholder="ค้นหารหัสธุรกรรม ผู้ใช้"
                        class="form-input"
                    />
                </div>
            ...
            <DataTable :items="filteredTransactions" :columns="tableColumns" :pageSize="10" :showPagination="true" idKey="id">
                <template #transaction="{ row }">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="font-mono text-sm font-medium text-primary">{{ row.order_reference || 'N/A' }}</div>
                    ...
                    <div class="flex items-center justify-start space-x-2">
                        ...
                        >
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm8 6a2 2 0 11-4 0 2 2 0 014 0zm-2 4a4 4 0 00-3.464 2H16a1 1 0 001-1.53A4 4 0 0012 13z" />
                            </svg>
                        </button>
                        ...
                        <!-- No files indicator -->
                        <span v-if="!row.payment_slip_url && !row.txid_screenshot_url" 
        ...
        <!-- Empty State -->
        <div v-if="!loading && filteredTransactions.length === 0" class="text-center p-8 rounded-md bg-white dark:bg-gray-900 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-4xl z-10">
                    ...
                    <div v-if="selectedTransaction" class="space-y-6">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                            <div class="flex items-center gap-4">
                                <div class="w-12 h-12 rounded-full bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 flex items-center justify-center font-medium text-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <span 
                                        :class="selectedTransaction.transaction_type === 'buy' 
                                            ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' 
                                            : 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400'"
                            ...
                            <!-- Amount Details -->
                            <div class="space-y-4">
                                <h5 class="font-semibold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2">รายละเอียดจำนวนเงิน</h5>
                                
                                <div>
                                    <label class="text-sm text-gray-600 dark:text-gray-400 block mb-1">จำนวนเงินต้นทาง</label>
                                    <p class="font-semibold text-lg">{{ formatCurrency(selectedTransaction.from_amount) }} {{ selectedTransaction.from_currency }}</p>
                                </div>

                                <div>
                                    <label class="text-sm text-gray-600 dark:text-gray-400 block mb-1">จำนวนเงินปลายทาง</label>
                                    <p class="font-semibold text-lg">{{ formatCurrency(selectedTransaction.to_amount) }} {{ selectedTransaction.to_currency }}</p>
                                </div>
                        ...
                        <!-- Payment Details -->
                        <div v-if="selectedTransaction.customer_bank_code || selectedTransaction.customer_account_number || selectedTransaction.customer_receive_bank_code" class="space-y-4">
                            <h5 class="font-semibold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2">ข้อมูลการชำระเงิน</h5>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <button
                                    v-if="selectedTransaction.payment_slip_url"
                                ...
                                <button
                                    v-if="selectedTransaction.txid_screenshot_url"
                                ...
                                <div v-if="!selectedTransaction.payment_slip_url && !selectedTransaction.txid_screenshot_url" class="text-gray-500 dark:text-gray-400 italic">
                                    ไม่มีไฟล์แนบ
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex justify-end mt-8 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <button @click="closeDetailModal" class="btn btn-outline-primary">
                            ปิด
                        </button>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md z-10">
                    ...
                    <div class="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <button @click="closeStatusModal" class="btn btn-outline-secondary">
                            ยกเลิก
                        </button>
                        <button 
